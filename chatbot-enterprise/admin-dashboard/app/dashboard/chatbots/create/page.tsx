        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Configure your new AI chatbot with knowledge bases and custom settings
            </p>
          </div>
        </div>
                  ...
                  <div className="relative border-2 border-dashed border-slate-300 rounded-lg p-4 min-h-[400px] bg-slate-50">
                    ...
                    <div className="mt-4 p-3 bg-white rounded border">
                      ...
                      <div className="grid grid-cols-2 gap-2 text-xs text-muted-foreground">
                        ...
                        <div>Color: {config.appearance.primaryColor}</div>
                        <div>Border Radius: {config.appearance.borderRadius}</div>
                        <div>Font: {config.appearance.fontFamily}</div>
                        <div>Knowledge Bases: {selectedKnowledgeBases.length}</div>
                        <div>Welcome: {config.welcomeMessage.substring(0, 20)}...</div>
                      </div>
                    </div>
                  </div>
                ) : (
